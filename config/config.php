...
function pinjamBuku($dataBuku) {
  ...
  // Tambahkan kolom status dengan nilai default "Belum konfirmasi"
  ...
  $queryPinjam = "INSERT INTO peminjaman (id_buku, nisn, nama_admin, tgl_peminjaman, tgl_pengembalian, status) 
